...
#define rwPLUGIN_ID      rwID_FILESYSTEMPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionFS
#define rwPLUGIN_ERRENUM e_rwdb_CriterionFS
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionFSLAST
