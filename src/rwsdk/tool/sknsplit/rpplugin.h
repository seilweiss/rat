 ...
 * mechanism
 */
#define rwPLUGIN_ID      rwID_SKINSPLITTOOKIT
#define rwPLUGIN_ERRFUNC _rwdb_CriterionSkinSplit
#define rwPLUGIN_ERRENUM e_rwdb_CriterionSkinSplit
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionSkinSplitLAST
