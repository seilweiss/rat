...
/*---- start: c:/RW/Graphics/rwsdk/plugin/ptank/d3d9/ptankplatform.h----*/

/**
 * \defgroup rpptankgcn GCN
 * \ingroup rpptank
 *
 * GCN specific documentation.
 */

/*---- end: c:/RW/Graphics/rwsdk/plugin/ptank/d3d9/ptankplatform.h----*/
